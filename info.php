      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 text-center mx-auto">
            <h1 class="text-white pt-3 mt-n5">Sobre a Kuromi Imóveis:</h1>
          ...
          <div class="row justify-content-left">
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Captação de Imóveis</h5>
                <p>Nós buscamos captar os melhores imóveis pelo melhor preço</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Pagamentos</h5>
                <p>A parte de venda é feita diretamente com o vendedor fez o anuncio, sendo o mesmo vinculado com a nossa empresa.</p>
              </div>
            </div>
          </div>
          <div class="row justify-content-left">
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Tipo de Imóveis</h5>
                <p>Nossa captação consiste em imóveis mobiliados e perto de você!</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>E-commerce</h5>
                <p>Não possuimos empresa fisica, apenas online. Acreditamos que a técnologia muda vidas.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 ms-auto mt-lg-0 mt-4">
          <div class="card shadow-lg">
            ...
            <div class="card-body">
              ...
              <p>
               Desde 2021 realizando o sonho da casa própria de maneira completamente online! Cadastre-se em nosso site e acompanhe de perto nosso modelo de trabalho.
              </p>
            </div>
          </div>
        </div>
